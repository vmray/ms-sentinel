...
def add_domain_indicator(
    domains: list, sample_id: str, submission_id: str, verdicts: list, incident_id
) -> None:
    """
...
def add_file_indicators(
    files: list, sample_id: str, submission_id: str, verdicts: list, incident_id: str
) -> None:
    """
...
def add_ip_indicator(
    ips: list, sample_id: str, submission_id: str, verdicts: list, incident_id: str
) -> None:
    """
...
def add_url_indicator(
    urls: list, sample_id: str, submission_id: str, verdicts: list, incident_id: str
):
    """
